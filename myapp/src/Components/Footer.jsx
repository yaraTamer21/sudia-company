		...
		<>
			<footer >
				<div class="container">
					<div data-aos="fade-up"
							...
							<div class="box-link-web">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6">
										<ul>
											<li><a href="#">الخدمات الماليه</a></li>
											<li><a href="#"> الخدمات التجاريه </a></li>
						...
						<div class="col-lg-3 col-md-6">
							<div class="box-link-web">
								<h3>فروعنا</h3>
								<ul class="soch">
									<li><a href="#"> السعوديه   <span>    966565821156+
					...
					<div class="Copy">
						Copyright 2018 Be Group, All Rights Reserved
					</div>
				</div>
